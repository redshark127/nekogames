...
// ── Storage shim handler (proxied game iframes) ──
window.addEventListener('message', function(e) {
  ...
  if (t === 'ng-s-req') {
    ...
    e.source.postMessage({type: 'ng-s-init', d: d}, '*');
  } else if (t === 'ng-s-set') {
    localStorage.setItem(e.data.k, e.data.v);
  } else if (t === 'ng-s-del') {
    localStorage.removeItem(e.data.k);
  } else if (t === 'ng-s-clr') {
    localStorage.clear();
  }
});
